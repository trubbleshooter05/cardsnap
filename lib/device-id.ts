...
const STORAGE_KEY = CARDSNAP_DEVICE_COOKIE;
...
/** Persist device id across refresh and login (same browser profile, not incognito). */
export function persistDeviceId(id: string): void {
